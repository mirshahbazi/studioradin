...
class Styles {
  ...
  /// Colors.
  static const primaryColor = Color(0xff003A79);
  static const secenderyColor = Color(0xff797C7B);
  ...
  static const white12 = Color(0xffFEFEFE);
  ...
  static const grey28 = Color(0xff797C7B);
  static const grey29 = Color(0xffF7F7FC);
  static const grey30 = Color(0xffEDEDED);
  static const grey31 = Color(0xffCCCED5);
  ...
  static const black6 = Color(0xff000E08);
  ...
  static const blue12 = Color(0xffC5D4FF);
  static const blue13 = Color(0xff1A73E8);
  ...
  static const green11 = Color(0xffE1F6DF);
  ...
  // Cyan
  static const cyan8                                                            = Color(0xffF5B7BE);
  ...
  static const pink5 = Color(0xffF6F6F6);
  ...
  //Big.
  static TextStyle bigText({Color color = black2, double size = 18}) =>
      getTextStyle(color, size, FontWeight.bold);
